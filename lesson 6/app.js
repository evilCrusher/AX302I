...
function drawCircle() {
	...
	ctx.drwImage(circle, circleX, circleY, circleS, circleS);
}
...
function init() {
	...
	// (window means any key on the keyboard)
...
function draw() {
	...
	drawPacman();
	drawCircle();
	// Tells our sprite to bounce off the walls and go in opposite
...
function collisionCheck() {
	if( (x+s >= circleX) && (x <= circleX + circleS) && (y+s >= circleY + circleY)) {
